                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        recommended sizes
                            ...
                            height: 35px;
                        -->
                        <a href="#" class="navbar-brand smooth-scroll"><img src="images/logo-black.png"
                                alt="logo" /></a>
            ...
            <div class="container vertical-center-rel">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-0">
                        ...
                        <p class="text-white">"Perfect for kids 3years and Above"</p>
                    </div><!-- /End Col -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center single-line">
                        ...
                        <a href="#contact8-2" class="btn btn-ghost btn-md smooth-scroll">Order Now <i
                                class="fa fa-arrow-right m-l"></i></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="content7-1" class="p-y-lg">
            ...
            <div class="row" style="text-align: center;">
                <div class="" style="margin-bottom: 20px;">
                    <iframe width="100%" height="350" src="https://www.youtube.com/embed/UXHP3WxupBQ"
                        title="Magic Calligraphy Book for Kids." frameborder="0"
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 content-block c3">
                        <div class="col-sm-4">
                            <a href="#"><img src="images/number_magic.jpg" alt=""
                        ...
                        <div class="col-sm-4">
                            <a href="#"><img src="images/letter_magic.jpg" alt=""
                                    class="img-responsive img-rounded"></a>
                            <div class="post-info">
                                <div class="date text-edit" style="background-color:#ef7c46;">
                                    <span class="day">40%</span>
                    ...
                    <div class="col-md-12 c3 testimonials">
                        ...
                        <div class="col-md-4 clearfix">
                            <div class="embed-tweet-item">
                                <blockquote class="twitter-tweet" lang="en" data-link-color="#439FE0"
                                    data-align="center">
                        ...
                        <div class="col-md-4">
                            <div class="pricing-table" style="text-align: center;">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="m-t p-b"><a href="#contact8-2"
                                            class="btn btn-shadow btn-blue text-uppercase smooth-scroll">Order NOW</a>
                                    </li>
                                </ul>
                            </div>
                        </div><!-- /End Col Price -->
            ...
            <div class="row y-middle c2">
                ...
                <div class="col-md-6">
                    <form class="form-horizontal form-white" id="quoteForm">
                        ...
                        <div class="form-group">
                            <select class="form-control form-control-lg" name="pack" id="pack">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-8 text-white">
                    <p>All rights reserved - Copyright &copy; <?php echo date("Y"); ?> EmeraldStore by <a href="#"
                            class="f-w-900 inverse">Themedept</a></p>
                </div>
                <!-- Social Links -->
                <div class="col-sm-4">
